        ...
        <table border="1" width="100%"  >
            ...
            <tbody>
                <%
                    ...
                    out.write("<h3> College Name: "+eiid+" </h3>");
                    while (r.next()) {
                        pd = r.getInt(1);
                        String q1 = "select p.name , p.college1 , p.rollno ,ps.* from participant as p,participation as ps where ps.pid='" + pd + "' and p.pid='" + pd + "'and college1='"+eiid+"'";
